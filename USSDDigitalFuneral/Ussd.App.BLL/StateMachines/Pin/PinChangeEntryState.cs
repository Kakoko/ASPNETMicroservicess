...
{
    public class PinChangeEntryState : MenuState
    {

        public PinChangeEntryState(MenuState previousState) : base(previousState)
        {

        }

        public PinChangeEntryState(UssdMenu<LanguageDto> handle, LanguageDto language, IDictionary<string, object> valueStash)
        ...
        public override async ValueTask<UssdResponseDTO> ProccessRequest(UssdRequestDTO request)
        {
            ...
            menuBuilder.AppendNewLine("Enter your PIN");
            menuBuilder.AppendNewLine("77. Forgot PIN?");
            ...
            Handle.CurrentState = new PinChangeExitState(this)
            {
