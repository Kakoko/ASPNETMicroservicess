...
{
    public class UnregisteredCustomerEntryState : MenuState
    {

        public UnregisteredCustomerEntryState(MenuState previousState) : base(previousState)
        {

        }

        public UnregisteredCustomerEntryState(UssdMenu<LanguageDto> handle, LanguageDto language, IDictionary<string, object> valueStash)
        ...
        public override async ValueTask<UssdResponseDTO> ProccessRequest(UssdRequestDTO request)
        {
            ...
            menuBuilder.AppendNewLine(CurrentLanguage.ContactCustomerCare);
            ...
            Handle.CurrentState = new UnregisteredCustomerExitState(this)
            {
