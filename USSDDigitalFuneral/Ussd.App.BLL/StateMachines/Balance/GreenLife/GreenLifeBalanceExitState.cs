...
{
    public class GreenLifeBalanceExitState : MenuState
    {

        public GreenLifeBalanceExitState(MenuState previousState) : base(previousState)
        {

        }

        public GreenLifeBalanceExitState(UssdMenu<LanguageDto> handle, LanguageDto currentLanguage, IDictionary<string, object> valueStash)
        ...
        {
            var errorState = new GreenLifeBalanceEntryState(this)
            {
