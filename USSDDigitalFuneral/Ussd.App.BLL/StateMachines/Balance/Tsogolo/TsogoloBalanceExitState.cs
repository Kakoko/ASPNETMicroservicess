...
{
    public class TsogoloBalanceExitState : MenuState
    {

        public TsogoloBalanceExitState(MenuState previousState) : base(previousState)
        {

        }

        public TsogoloBalanceExitState(UssdMenu<LanguageDto> handle, LanguageDto currentLanguage, IDictionary<string, object> valueStash)
        ...
        {
            var errorState = new TsogoloBalanceEntryState(this)
            {
