...
{
    public class BalanceExitState : MenuState
    {

        public BalanceExitState(MenuState previousState) : base(previousState)
        {

        }

        public BalanceExitState(UssdMenu<LanguageDto> handle, LanguageDto currentLanguage, IDictionary<string, object> valueStash)
        ...
        {
            var errorState = new BalanceEntryState(this)
            {
