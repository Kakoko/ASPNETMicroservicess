...
{
    public class WithdrawExitState : MenuState
    {

        public WithdrawExitState(MenuState previousState) : base(previousState)
        {

        }

        public WithdrawExitState(UssdMenu<LanguageDto> handle, LanguageDto currentLanguage, IDictionary<string, object> valueStash)
        ...
        {
            var errorState = new WithdrawEntryState(this)
            {
