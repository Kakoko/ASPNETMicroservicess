...
{
    public class ErrorStateExitState : MenuState
    {

        public ErrorStateExitState(MenuState previousState) : base(previousState)
        {

        }

        public ErrorStateExitState(UssdMenu<LanguageDto> handle, LanguageDto currentLanguage, IDictionary<string, object> valueStash)
        ...
        {
            var errorState = new ErrorStateEntryState(this)
            {
